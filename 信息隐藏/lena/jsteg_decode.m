fid=fopen('C:\Users\lovebear96\Desktop\lena\encode.dat','rb');
enco=fread(fid);      %get the huffman code
...
for i=1:len
    for j=1:wid
        if(rev_ld2(i,j)~=1 || rev_ld2(i,j)~=-1 || rev_ld2(i,j)~=0)
...
imwrite(rev_img,'C:\Users\lovebear96\Desktop\lena\666eight.bmp');
